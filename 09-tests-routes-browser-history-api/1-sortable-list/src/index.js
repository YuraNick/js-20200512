export default class SortableList {
    LIST_CLASS = 'sortable-list';
    ITEM_CLASS = 'sortable-list__item';
    DRAG_CLASS = 'sortable-list__item_dragging';
    PLACEHOLDER_CLASS = 'sortable-list__placeholder';
    ...
    dragStart = (event) => {
        ...
        dragElement.classList.add(this.DRAG_CLASS);
    ...
    dragEnd = (event) => {
        ...
        dragElement.remove();
        dragElement.classList.remove(this.DRAG_CLASS);
    ...
    render(items) {
        ...
        element.classList.add(this.LIST_CLASS);

        element.append(...items);

        this.items = element.getElementsByClassName(this.ITEM_CLASS);
